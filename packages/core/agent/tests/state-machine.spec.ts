...
import { canTransition, assertTransition, createTransition, isTerminal, isActive, isWaiting, InvalidAgentTransitionError, type AgentState } from '../src/state-machine.ts'
