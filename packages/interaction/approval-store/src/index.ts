...
export type { ApprovalRecord } from './types.ts'

const store = new Map<string, ApprovalRecord>()
const waitingRuns = new Set<string>()

export function request(runId: string, requestDigest: string, policyVersion: string, actor: string,
  deadlineMs: number = 86400000): ApprovalRecord {
