...
| preset `approvalThreshold` | `destructive` | Per preset: the class at or above which an action requires approval before it executes; a preset the table does not carry falls back to the strictest configured value |
