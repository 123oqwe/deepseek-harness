...
// does (P2-02.U). Re-exported here because this module's existing importers
// name it, and a second definition would be the second answer to "may this
// child hold this authority" that the lift exists to prevent.
export {
  attenuateDelegatedToken,
  delegatedChildResources,
  DelegatedCapabilityError,
} from '@deepseek-ai/dsh-capability-token/delegate'
export type {
  ChildResourceFilter,
