   ...
   describe('validateManifest', () => {
     ...
     it('requires sideEffect and dataClassification on tools', () => {
       const manifest: PluginManifestV2 = {
         ...benignManifest,
         tools: [{ name: 'bad-tool', description: 'No sideEffect', sideEffect: undefined as any, dataClassification: undefined as any }],
       }
     ...
     it('requires transport for MCP servers', () => {
       const manifest: PluginManifestV2 = {
         ...benignManifest,
         mcpServers: [{ name: 'bad-mcp', transport: undefined as any, auth: 'none', sideEffect: 'none', tools: [] }],
       }
       const result = validateManifest(manifest)
       expect(result.valid).toBe(false)
