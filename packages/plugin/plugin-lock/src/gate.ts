...
import { admitBoot } from './index.ts'
...
export type GateOutcome =
  | { readonly admitted: true; readonly loadOrder: readonly PluginPackageName[]; readonly verified: boolean }
  | { readonly admitted: false; readonly gateReason: GateDenialReason }
  | { readonly admitted: false; readonly admission: BootAdmission }
