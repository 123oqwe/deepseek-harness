...
export type Compensation =
  | { readonly reversible: true; readonly capability: CapabilityRef; readonly argumentsHash: ArgumentsHash; readonly description: string }
  | { readonly reversible: false; readonly reason: string }
...
export type ExecutionGateDecision =
  | { readonly admitted: true; readonly manifest: ActionManifest }
  | { readonly admitted: false; readonly reason: ExecutionGateDenialReason }
