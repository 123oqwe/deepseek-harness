...
class EmptySandbox extends SandboxProvider {
  confine(_argv: readonly string[], _policy: SandboxPolicy): ConfinedArgv {
    return { argv: [], backend: 'empty', enforcement: 'full', reachableSockets: [], denialSignatures: [], runnerFailureRules: [] }
  }
}
...
class RecordingSandbox extends SandboxProvider {
  ...
  confine(argv: readonly string[], policy: SandboxPolicy): ConfinedArgv {
    ...
    return { argv: ['/sandbox', '--', ...argv], backend: 'recording', enforcement: 'full', reachableSockets: [], denialSignatures: [], runnerFailureRules: [] }
  }
}
