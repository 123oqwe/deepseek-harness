...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  CapabilityRegistration: 'capability ownership record is owned by packages/plugin/plugin-ownership/README.md',
  CapabilityRecord: 'token-free view of a capability ownership record is owned by packages/plugin/plugin-ownership/README.md',
  OwnershipToken: 'capability ownership token is owned by packages/plugin/plugin-ownership/README.md',
  ...
  SignedCapabilityToken: 'signed capability token is owned by packages/policy/capability-token/README.md',
  SessionIdLike: 'the session identifier this contract sees, structurally a string so the definition package does not depend on the session runtime — owned by packages/policy/capability-token/README.md',
  ChildResourceFilter: 'one child delegation restriction is owned by packages/policy/capability-token/README.md',
  ...
  ActionRiskSubject: 'action risk subject is owned by packages/policy/risk-taxonomy/README.md',
  RiskClassification: 'risk classification result is owned by packages/policy/risk-taxonomy/README.md',
  ...
  CurrentPolicySet: 'the policy set in force at a decision, and the digest that decision records, is owned by packages/policy/policy-engine/README.md',
  BreakerDestination: 'breaker destination keying is owned by packages/reliability/retry/README.md',
  BudgetDecision: 'retry budget admission outcome is owned by packages/reliability/retry/README.md',
  RunId: 'execution-run identity is owned by packages/identity/principal/README.md',
  ...
  MemoryListPendingRequest: 'service-local request contract is owned by packages/memory/memory/src/types.ts',
  MemoryListPendingResult: 'service-local result contract is owned by packages/memory/memory/src/types.ts',
  MemoryReviewRequest: 'service-local request contract is owned by packages/memory/memory/src/types.ts',
