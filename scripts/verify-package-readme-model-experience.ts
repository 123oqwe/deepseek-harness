...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/workflow/workflow-journal': { kind: 'none', reason: 'Epic P4-08 journal: resume decisions and compaction over a recorded journal, registering no prompt, schema, tool, or session event.' },
