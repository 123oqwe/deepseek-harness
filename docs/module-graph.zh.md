...
flowchart TD
  ...
  subgraph group_action["packages/action"]
    pkg_action_ledger["action-ledger"]
    pkg_action_manifest["action-manifest"]
  end
  ...
  subgraph group_assurance["packages/assurance"]
    pkg_evidence_format["evidence-format"]
  end
  ...
  subgraph group_credentials["packages/credentials"]
    ...
    pkg_secrets_broker["secrets-broker"]
  end
  ...
  subgraph group_execution["packages/execution"]
    ...
    pkg_resource_budget["resource-budget"]
  end
  ...
  subgraph group_reliability["packages/reliability"]
    pkg_retry["retry"]
    pkg_retry_cockatiel["retry-cockatiel"]
  end
  ...
  subgraph group_schema["packages/schema"]
    pkg_schema_registry["schema-registry"]
  end
  ...
  subgraph group_session["packages/session"]
    ...
    pkg_session_lifecycle["session-lifecycle"]
  ...
  subgraph group_test_support["packages/test-support"]
    ...
    pkg_job_settle_signal["job-settle-signal"]
  ...
  pkg_action_manifest --> pkg_brand
  pkg_action_manifest --> pkg_principal
  pkg_action_manifest --> pkg_util_values
  ...
  pkg_schema_registry --> pkg_invariants
  pkg_schema_registry --> pkg_session
  ...
  pkg_agent --> pkg_control_priority
  pkg_agent --> pkg_human_channel
  pkg_agent --> pkg_intake_dedup
  pkg_agent --> pkg_invariants
  pkg_agent --> pkg_lease_contract
  pkg_agent --> pkg_llm
  pkg_agent --> pkg_principal
  pkg_agent --> pkg_scope
  ...
  pkg_workspace --> pkg_workspace_trust
  ...
  pkg_skill_filesystem --> pkg_workspace_trust
  ...
  pkg_memory_context --> pkg_principal
  ...
  pkg_resource_budget --> pkg_execution_world
  ...
  pkg_workspace_trust_local --> pkg_cmdline
  pkg_workspace_trust_local --> pkg_principal
  pkg_workspace_trust_local --> pkg_workspace
  pkg_workspace_trust_local --> pkg_workspace_trust
  ...
  pkg_job_settle_signal --> pkg_jobs
  ...
  pkg_tools --> pkg_action_ledger
  pkg_tools --> pkg_action_manifest
  pkg_tools --> pkg_agent
  pkg_tools --> pkg_code_runtime
  pkg_tools --> pkg_execution_world
  pkg_tools --> pkg_invariants
  pkg_tools --> pkg_lease_contract
  pkg_tools --> pkg_llm
  pkg_tools --> pkg_plugin_ownership
  pkg_tools --> pkg_policy_enforcement
  pkg_tools --> pkg_policy_engine
  pkg_tools --> pkg_risk_taxonomy
  pkg_tools --> pkg_scope
  ...
  pkg_agent_loop --> pkg_action_ledger
  pkg_agent_loop --> pkg_action_manifest
  pkg_agent_loop --> pkg_agent
  pkg_agent_loop --> pkg_control_priority
  pkg_agent_loop --> pkg_invariants
  pkg_agent_loop --> pkg_llm
  pkg_agent_loop --> pkg_policy_enforcement
  pkg_agent_loop --> pkg_principal
  ...
  pkg_cordis_host_runner --> pkg_plugin_ownership
  ...
  pkg_mcp_client --> pkg_brand
  pkg_mcp_client --> pkg_llm
  pkg_mcp_client --> pkg_retry
  pkg_mcp_client --> pkg_risk_taxonomy
  ...
  pkg_session_query --> pkg_principal
  ...
  pkg_session_query --> pkg_workspace
  pkg_acp --> pkg_agent
  pkg_acp --> pkg_agent_loop
  pkg_acp --> pkg_attachment
  pkg_acp --> pkg_control_plane
  pkg_acp --> pkg_llm
  pkg_acp --> pkg_mcp_client
  pkg_acp --> pkg_principal
  pkg_acp --> pkg_session
  ...
  pkg_compaction_basic --> pkg_retry
  ...
  pkg_host_plugin_inventory --> pkg_plugin_compat
  pkg_host_plugin_inventory --> pkg_plugin_manifest
  pkg_host_plugin_inventory --> pkg_plugin_ownership
  pkg_host_plugin_inventory --> pkg_plugin_provenance
  ...
  pkg_subagent --> pkg_capability_token
  pkg_subagent --> pkg_control_priority
  pkg_subagent --> pkg_invariants
  pkg_subagent --> pkg_jobs
  pkg_subagent --> pkg_llm
  pkg_subagent --> pkg_message_bus
  pkg_subagent --> pkg_principal
  ...
  pkg_session_lifecycle --> pkg_attachment
  pkg_session_lifecycle --> pkg_brand
  pkg_session_lifecycle --> pkg_principal
  pkg_session_lifecycle --> pkg_session
  pkg_session_lifecycle --> pkg_session_query
  pkg_session_lifecycle --> pkg_workspace
  ...
  pkg_subagent_in_process_driver --> pkg_jobs
  ...
  pkg_sdk_protocol --> pkg_principal
  ...
  pkg_workflow_worker_thread --> pkg_session_persistence
  ...
  pkg_sdk_jsonrpc_server --> pkg_principal
...
| [`control-priority`](../packages/collaboration/control-priority) | `collaboration` | — |
...
| [`skill-filesystem`](../packages/skill/skill-filesystem) | `skill` | [`fs`](../packages/fs/fs), [`home-paths`](../packages/util/home-paths), [`skill`](../packages/skill/skill), [`workspace-trust`](../packages/workspace/workspace-trust) |
...
| [`tmux-context`](../packages/context/tmux-context) | `context` | [`agent`](../packages/core/agent), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`session-projection`](../packages/session/session-projection), [`shell`](../packages/shell/shell) |
...
| [`workspace-trust-local`](../packages/workspace/workspace-trust-local) | `workspace` | [`cmdline`](../packages/boot/cmdline), [`principal`](../packages/identity/principal), [`workspace`](../packages/workspace/workspace), [`workspace-trust`](../packages/workspace/workspace-trust) |
...
| [`mcp-client`](../packages/mcp/mcp-client) | `mcp` | [`agent`](../packages/core/agent), [`attachment`](../packages/attachment/attachment), [`brand`](../packages/util/brand), [`llm`](../packages/llm/llm), [`retry`](../packages/reliability/retry), [`risk-taxonomy`](../packages/policy/risk-taxonomy), [`scope`](../packages/core/scope), [`session`](../packages/core/session), [`subprocess`](../packages/subprocess/subprocess), [`timeout`](../packages/util/timeout), [`tools`](../packages/core/tools) |
...
| [`acp`](../packages/acp/acp) | `acp` | [`agent`](../packages/core/agent), [`agent-loop`](../packages/core/agent-loop), [`attachment`](../packages/attachment/attachment), [`control-plane`](../packages/interaction/control-plane), [`llm`](../packages/llm/llm), [`mcp-client`](../packages/mcp/mcp-client), [`principal`](../packages/identity/principal), [`session`](../packages/core/session), [`session-persistence`](../packages/session/session-persistence), [`token-meter`](../packages/llm/token-meter), [`user-approval`](../packages/interaction/user-approval) |
...
| [`app-boot`](../packages/boot/app-boot) | `boot` | [`agent-loop`](../packages/core/agent-loop), [`home-paths`](../packages/util/home-paths), [`host-user-id`](../packages/identity/host-user-id), [`launch-environment`](../packages/util/launch-environment), [`principal`](../packages/identity/principal), [`system-prompt`](../packages/core/system-prompt) |
| [`web-app`](../packages/bundle/web-app) | `bundle` | [`shell-env`](../packages/shell/shell-env), [`system-prompt`](../packages/core/system-prompt) |
| [`compaction-basic`](../packages/compaction/compaction-basic) | `compaction` | [`agent`](../packages/core/agent), [`brand`](../packages/util/brand), [`commands`](../packages/interaction/commands), [`compaction`](../packages/compaction/compaction), [`compaction-tool-result-pruner`](../packages/compaction/compaction-tool-result-pruner), [`llm`](../packages/llm/llm), [`retry`](../packages/reliability/retry), [`session`](../packages/core/session), [`token-meter`](../packages/llm/token-meter) |
...
| [`host-plugin-inventory`](../packages/host/plugin-inventory) | `host` | [`agent-presets`](../packages/preset/agent-presets), [`brand`](../packages/util/brand), [`plugin-compat`](../packages/plugin/plugin-compat), [`plugin-manifest`](../packages/plugin/plugin-manifest), [`plugin-ownership`](../packages/plugin/plugin-ownership), [`plugin-provenance`](../packages/plugin/plugin-provenance), [`tools`](../packages/core/tools), [`typert-protocol`](../packages/typert/protocol) |
...
| [`webhook`](../packages/webhook/webhook) | `webhook` | [`agent`](../packages/core/agent), [`agent-default-model`](../packages/core/agent-default-model), [`agent-presets`](../packages/preset/agent-presets), [`host-user-id`](../packages/identity/host-user-id), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`permission-presets`](../packages/interaction/permission-presets), [`principal`](../packages/identity/principal), [`session`](../packages/core/session), [`session-title`](../packages/session/session-title), [`workspace`](../packages/workspace/workspace) |
| [`subagent`](../packages/subagent/subagent) | `subagent` | [`agent`](../packages/core/agent), [`agent-presets`](../packages/preset/agent-presets), [`attachment`](../packages/attachment/attachment), [`brand`](../packages/util/brand), [`capability-token`](../packages/policy/capability-token), [`control-priority`](../packages/collaboration/control-priority), [`invariants`](../packages/runtime-diagnostics/invariants), [`jobs`](../packages/jobs/jobs), [`llm`](../packages/llm/llm), [`message-bus`](../packages/run/message-bus), [`principal`](../packages/identity/principal), [`sandbox`](../packages/sandbox/sandbox), [`sandbox-policy`](../packages/sandbox/sandbox-policy), [`scope`](../packages/core/scope), [`session`](../packages/core/session), [`session-persistence`](../packages/session/session-persistence), [`session-projection`](../packages/session/session-projection), [`session-projection-cache`](../packages/session/session-projection-cache), [`session-query`](../packages/session-query/session-query), [`system-prompt`](../packages/core/system-prompt), [`taskboard`](../packages/collaboration/taskboard), [`tools`](../packages/core/tools), [`trust-kernel`](../packages/kernel/trust-kernel), [`typert-protocol`](../packages/typert/protocol), [`user-approval`](../packages/interaction/user-approval), [`util-time`](../packages/util/time) |
...
| [`session-lifecycle`](../packages/session/session-lifecycle) | `session` | [`attachment`](../packages/attachment/attachment), [`brand`](../packages/util/brand), [`principal`](../packages/identity/principal), [`session`](../packages/core/session), [`session-query`](../packages/session-query/session-query), [`workspace`](../packages/workspace/workspace) |
...
| [`subagent-in-process-driver`](../packages/subagent/subagent-in-process-driver) | `subagent` | [`agent`](../packages/core/agent), [`jobs`](../packages/jobs/jobs), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`subagent`](../packages/subagent/subagent), [`system-prompt`](../packages/core/system-prompt), [`tools`](../packages/core/tools) |
...
| [`api-session-controller`](../packages/api/session-controller) | `api` | [`agent`](../packages/core/agent), [`agent-default-model`](../packages/core/agent-default-model), [`agent-presets`](../packages/preset/agent-presets), [`api-gateway`](../packages/api/gateway), [`attachment`](../packages/attachment/attachment), [`client-connection`](../packages/client/connection), [`client-file-upload`](../packages/client/file-upload), [`commands`](../packages/interaction/commands), [`control-plane`](../packages/interaction/control-plane), [`file-reference`](../packages/context/file-reference), [`fs`](../packages/fs/fs), [`host-user-id`](../packages/identity/host-user-id), [`jobs`](../packages/jobs/jobs), [`llm`](../packages/llm/llm), [`native-command`](../packages/util/native-command), [`principal`](../packages/identity/principal), [`scope`](../packages/core/scope), [`session`](../packages/core/session), [`session-persistence`](../packages/session/session-persistence), [`session-projection`](../packages/session/session-projection), [`session-projection-cache`](../packages/session/session-projection-cache), [`session-query`](../packages/session-query/session-query), [`session-title`](../packages/session/session-title), [`skill`](../packages/skill/skill), [`subagent`](../packages/subagent/subagent), [`typert-protocol`](../packages/typert/protocol), [`typert-registry`](../packages/typert/registry), [`util-time`](../packages/util/time), [`util-values`](../packages/util/values), [`util-workspace-path`](../packages/util/workspace-path), [`workspace`](../packages/workspace/workspace) |
...
| [`workflow-worker-thread`](../packages/workflow/workflow-worker-thread) | `workflow` | [`action-ledger`](../packages/action/action-ledger), [`agent`](../packages/core/agent), [`brand`](../packages/util/brand), [`home-paths`](../packages/util/home-paths), [`lease-contract`](../packages/collaboration/lease-contract), [`llm`](../packages/llm/llm), [`principal`](../packages/identity/principal), [`session`](../packages/core/session), [`session-persistence`](../packages/session/session-persistence), [`subagent`](../packages/subagent/subagent), [`tools`](../packages/core/tools), [`workflow`](../packages/workflow/workflow), [`workflow-journal`](../packages/collaboration/workflow-journal), [`workflow-registry`](../packages/workflow/workflow-registry) |
