...
来源：[`packages/core/agent/src/types.ts:67`](../packages/core/agent/src/types.ts)
...
<a id="identityattached--log-only"></a>

#### `identity/attached` — log-only
...
来源：[`packages/memory/memory/src/types.ts:204`](../packages/memory/memory/src/types.ts)
