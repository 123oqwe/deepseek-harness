...
It does not choose the language shape (question 2), the U consumer (question 1), or the meaning of ten thousand (question 3). Those three are the delegate's, and two of them change the size of the epic by more than a factor. The remaining three are measurements I will make at C and report, not questions.
